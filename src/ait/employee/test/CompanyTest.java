...
class CompanyTest {
    ...
    void setUp() {
        ...
        firm[3] = new SalesManager(4000,"Robindranate","Agraval",80,20000,0.1);
    ...
    void addEmployee() {
        ...
        try {
            ...
            flag = true;
        } catch (RuntimeException e) { // словили RuntimeException
            flag = false;
    ...
    void testIncrement(){
        int a = 10;
        int b = a++ + ++a; // a++ <-- постфиксная запись ; ++a --> префиксная запись
        assertEquals(12,a);
        assertEquals(22,b);
    }
}